...
for net in range(1, 11):
    ...
    # stimulus records
    stim_tfrecs = os.path.join('Data', 'mcdermott', 'broadband_noise_elevation*.tfrecords')
    ...
    # ITD/ILD
    stim_itdild = os.path.join('Data', 'mcdermott', 'noise*_ITDILD.tfrecords')
...
for net in range(4, 11):
    ...
    trainedNet = os.path.join('netweights', f'net{net}')
    # stimulus records
    stim_tfrecs = os.path.join('Data', 'mcdermott', 'SL_unmodified_ears.tfrecords')
    # result name
...
# bandwidth
# stim_bd = os.path.join('Data', 'generated', 'noise_bandwidth*.tfrecords')
